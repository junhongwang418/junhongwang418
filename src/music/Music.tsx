...
const Music = () => {
  ...
  return (
    <Container maxWidth="md">
      ...
      <iframe width="560" height="315" src="https://www.youtube.com/embed/tdhSaEbfIko?autoplay=1&playlist=tdhSaEbfIko" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </Container>
  );
}
